 ...
 * contents of BPE.xs. Do not edit this file, edit BPE.xs instead.
 *
...
/* INCLUDE:  Including 'const-xs.inc' from 'BPE.xs' */


XS_EUPXS(XS_BPE_constant); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_BPE_constant)
{
    dVAR; dXSARGS;
    if (items != 1)
...
#line 18 "./const-xs.inc"
	type = constant(aTHX_ s, len);
      /* Return 1 or 2 items. First is error message, or undef if no error.
        ...
        case PERL_constant_NOTFOUND:
          sv =
	    sv_2mortal(newSVpvf("%s is not a valid BPE macro", s));
          PUSHs(sv);
          break;
        case PERL_constant_NOTDEF:
          sv = sv_2mortal(newSVpvf(
	    "Your vendor has not defined BPE macro %s, used",
				   s));
          PUSHs(sv);
          break;
	...
	/* Uncomment this if you need to return YESs
        ...
        default:
          sv = sv_2mortal(newSVpvf(
	    "Unexpected return type %d while processing BPE macro %s, used",
               type, s));
          PUSHs(sv);
        }
#line 269 "BPE.c"
...
/* INCLUDE: Returning to 'BPE.xs' from 'const-xs.inc' */


XS_EUPXS(XS_BPE_encode); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_BPE_encode)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "str, min_freq, ignore");
    {
	const char *	str = (const char *)SvPV_nolen(ST(0))
;
	int	min_freq = (int)SvIV(ST(1))
;
	const char *	ignore = (const char *)SvPV_nolen(ST(2))
;
	HV *	RETVAL;
#line 23 "BPE.xs"
...
extern "C"
#endif
XS_EXTERNAL(boot_BPE); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_BPE)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("BPE::constant", XS_BPE_constant);
        newXS_deffile("BPE::encode", XS_BPE_encode);
#if PERL_VERSION_LE(5, 21, 5)
